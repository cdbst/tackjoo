...
class ContentsAccounts extends React.Component {
    ...
    __setupColumnsWidth(){
        ...
        this.session_expired_timer_col_width = 160;
        this.email_col_width = 'calc( 100% - ' + (this.actions_col_width + this.status_col_width + this.session_expired_timer_col_width) + 'px)';
    }
    ...
    pushAccountTableItem(account_info, save_to_file){
        ...
        account_table_list.push(
            <AccountsTableItem 
                ...
                session_expired_timer_col_width={this.session_expired_timer_col_width}
                    ...
                    <table className="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style={{width : this.session_expired_timer_col_width, maxWidth : this.session_expired_timer_col_width}}>세션 만료 시간</th>
