    ...
    bmak && bmak["hasOwnProperty"]("ver") && bmak["hasOwnProperty"]("sed")
      ...
      : {
            ...
            try {
              if (
                ...
                void 0 !== e["isTrusted"] &&
                  ...
                  (c += ";"),
                  (bmak["me_vel"] =
                    bmak["me_vel"] + bmak["me_cnt"] + a + i + n + o),
              ...
              if (
                ...
                if (n && "mouse" != n["pointerType"]) {
                  ...
                  void 0 !== n["isTrusted"] &&
                    ...
                    (i += ",0"),
                    (bmak["pe_vel"] =
                      bmak["pe_vel"] + bmak["pe_cnt"] + a + r + o + m),
              ...
              (bmak["wv"] = "n"),
                ...
                a &&
                  ...
                  a["getSupportedExtensions"]() &&
                    ...
                    a["getSupportedExtensions"]()["indexOf"](
            ...
            try {
              if (
                ...
                void 0 !== e["isTrusted"] &&
                  ...
                  (bmak["ta"] += m),
                  (bmak["te_vel"] =
                    bmak["te_vel"] + bmak["te_cnt"] + a + m + n + o),
                  (bmak["doa_throttle"] = 0),
                  (bmak["dma_throttle"] = 0);
              }
          ...
          getforminfo: function () {
            ...
            return (
              null == bmak["ins"] && (bmak["ins"] = a), (bmak["cns"] = a), t
            );
          },
            ...
            try {
              if ((bmak["bpd"](), 0 == bmak["sdfn"]["length"])) {
                if (
                  ...
                  for (
                    var t = document["getElementsByName"]("bm-telemetry"),
                      a = 0;
                    a < t["length"];
                    a++
                  )
          ...
          bpd: function () {
            ...
            try {
              var F = bmak["od"](bmak["cs"], bmak["api_public_key"])["slice"](
                  0,
                  16
                ),
          ...
          startTracking: function () {
            ...
            setInterval(function () {
              ...
              bmak["js_post"] &&
                ((bmak["aj_type"] = 0), bmak["bpd"](), bmak["pd"](!0)),
              (bmak["firstLoad"] = !1);
          },
          gb: function (t, a) {
          ...
          encode: function (t) {
            ...
            return (
              ...
              t["length"] % 3 == 2 &&
                ...
                (r = (15 & e) << 2),
                (b =
                  b + c["charAt"](o) + c["charAt"](m) + c["charAt"](r) + "=")),
              b
            );
          },
          ie9OrLower: function () {
          ...
          mn_update_challenge_details: function (t) {
            (bmak["mn_sen"] = t[0]),
              ...
              (bmak["mn_cc"] =
                bmak["mn_abck"] + bmak["start_ts"] + bmak["mn_psn"]);
          },
              ...
              (bmak["mn_mc_indx"] += 1),
                bmak["mn_mc_indx"] < bmak["mn_mc_lmt"]
                  ...
                  : ((bmak["mn_mc_indx"] = 0),
                    ...
                    (bmak["mn_r"][bmak["mn_abck"] + bmak["mn_psn"]] =
                      bmak["mn_pr"]()),
                    bmak["js_post"] &&
                      ((bmak["aj_type"] = 8),
          ...
          calc_fp: function () {
            bmak["fpcf"]["fpVal"](),
              bmak["js_post"] &&
                ((bmak["aj_type"] = 9), bmak["bpd"](), bmak["pd"](!0));
          },
          listFunctions: {
        ...
        try {
          ...
          if (!a["sf4"]()) {
            ...
            if (
              ...
              (c["font"] = "6pt Arial"),
                (a["rVal"] = Math["floor"](1e3 * Math["random"]())[
                  "toString"
                ]()),
                c["fillText"](a["rVal"], 1, 12);
              for (
                var b = i["toDataURL"](), d = 0, s = 0;
                s < b["length"];
                s++
              ) {
        ...
        if (!a["sf4"]() && document["body"]) {
          ...
          for (
            ...
            (b = i["childNodes"][c]),
              ...
              (r[c] = b["offsetHeight"]);
          if (
            (document["body"]["removeChild"](i), bmak["get_cf_date"]() - e > t)
          )
            return "";
          var d = [
              "Geneva",
          ...
          for (
            ...
            for (r = 0; r < e["length"]; r++)
              if (
                ...
                document["body"]["appendChild"](m),
                (m["offsetWidth"] === n[r] && m["offsetHeight"] === o[r]) ||
                  (d = !0),
                document["body"]["removeChild"](m),
                d)
              ) {
